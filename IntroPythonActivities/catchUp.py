...
# ANSWER: a function that is already defined into a program to work with a set of statements to perform a task
# def() if() print()
...
if PAID_FOR_FOOD is True:
    print('here is your order, thank you for shopping')
else:
    print('you do not have enough money, please pay')
